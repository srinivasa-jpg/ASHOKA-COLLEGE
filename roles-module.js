(function(){
  ...
  const PERM_KEY='campusExamPermissions_v2';
  const MODULES=[
  ...
  const ROLES={
    ...
    student:{label:'Students',desc:'Limited student-facing access'}
  };
  const DEFAULTS={
    admin:{},
    ...
    student:{dashboard:{view:true},halltickets:{view:true},marks:{view:true}}
  };
